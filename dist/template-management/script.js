...
(function () {
    ...
    function getLoggedInUserEmail() {
        ...
        const userInfo = readStoredObject("user-info");
        const clientUser = readStoredObject("client-user");
        return String(userInfo.email || clientUser.email || "").trim();
    }
...
item.dataset.templateName =
    ...
    async function confirmSaveTemplate() {
        ...
        if (!loggedInEmail) {
            ...
            alert(
                "The logged-in user's email is unavailable. Please sign in again."
            );
